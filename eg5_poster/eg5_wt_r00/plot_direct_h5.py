...
#k.plot_rate()
k = Kinetics(scheme=f"WIPA/FULLY_UNBOUND2", state=1, ax=ax, tau=5**-10, label="Bound to Unbound")
k.plot_rate()
k = Kinetics(scheme=f"WIPA/TO_STUCK", state=1, ax=ax, tau=5**-10, label="Bound to Stuck")
k.plot_rate()
k = Kinetics(scheme=f"WIPA/STUCK_TO_UNBOUND", state=1, ax=ax, tau=5**-10, label="Stuck to Unbound")
k.plot_rate()
