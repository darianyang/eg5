...
binsperdim=[25, 1]   # You will have prod(binsperdim)+numberofdim*(2+2*splitIsolated)+activetarget bins total
pcoordlength=11 # length of the pcoord
...
mincap=[5, 0]
targetstate=[None, 10.1]    #enter boundaries for target state or None if there is no target state in that dimension
