...
@ray.remote
def process_iteration(n_iter, we_h5filename, refPDBfile, WEfolder):
...
if __name__ == "__main__":
    ...
    maxIter = h5py.File(we_h5filename, "r").attrs["west_current_iteration"]
    result_ids = []
    for n_iter in tqdm.tqdm(range(1, maxIter)):
        result_ids.append(process_iteration.remote(n_iter, we_h5filename, refPDBfile, WEfolder))
