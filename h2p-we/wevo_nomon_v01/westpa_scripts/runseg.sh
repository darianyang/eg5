...
ln -sv $WEST_SIM_ROOT/bstates/ref.ncrst .
...
COMMAND="$COMMAND reference ref.ncrst\n"
...
# Clean up
rm -f md.in parent.ncrst seg.nfo seg.pdb eg5_2022.prmtop 05_eq3.ncrst ref.ncrst *.dat
